...
import { createGroupPost } from "../apollo/grouppostquery";

interface GroupPostModalProp {
    group: {
        ID: string,
        Name: string,
        Admins: string[],
    ...
    handleInputActive: () => void;
}

export default function GroupPostModal({ group, handleInputActive }: GroupPostModalProp) {
    ...
    const [create_post] = useMutation(createGroupPost);
