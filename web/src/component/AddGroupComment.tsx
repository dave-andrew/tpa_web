...
import { createGroupComment } from "../apollo/grouppostquery"

export default function AddGroupComment({ user, post, comments, setComments, comment, setComment, repliedUser, setRepliedUser }: any) {

    const [create_comment] = useMutation(createGroupComment)
