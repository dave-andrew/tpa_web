...
import { getReplyComment } from "../apollo/postquery";


export default function Reply({ post, comment, markup, setRepliedUser, setComment }: any) {

    const { loading, data } = useQuery(getReplyComment, {
        variables: {
            postid: post,
